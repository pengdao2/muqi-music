...
/**
 * 解析 local:// URL 为实际文件路径
 * @param url local:// 协议 URL（如 local:///C:/path/to/file.mp3）
 * @returns 实际文件系统路径
 */
function resolveLocalUrlToPath(url: string): string {
  // local:///C:/Users/xxx.mp3 → /C:/Users/xxx.mp3 或 C:/Users/xxx.mp3
...
export function initializeFileManager() {
  ...
  protocol.handle('local', (request) => {
    try {
      ...
      // 使用 net.fetch 读取文件并返回（protocol.handle 的标准做法）
